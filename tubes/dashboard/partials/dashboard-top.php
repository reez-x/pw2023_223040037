  ...
  <div class="sidebar">
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          <li><a class="link_name" href="#">Berita</a></li>
          <li><a id="myButton">Insert</a></li>
          <li><a href="news.php" id="">Update / Edit</a></li>
          <li><a href="news-hapus.php" id="">Delete</a></li>
        </ul>
      </li>
      <li>
        <?php
    ...
    <div class="profile-details">
      ...
      <button id="">Klik untuk Mengganti</button>
  ...
  myButton.addEventListener("click", function() {
    ...
    xhr.onreadystatechange = function() {
      if (xhr.readyState === 4 && xhr.status === 200) {
        myTarget.innerHTML = xhr.responseText;
      }
    };
